def headxml(date,ddnCode_para):    
    ...
    ddnCode_para = {"modelIdentCode":"ARJ21","receiverIdent":"SVV19",
            "senderIdent":"SVV19","seqNumber":"00001","yearOfDataIssue":"2020"}
    para = {"day":date["day"],"month":date["month"],
            "year":date["year"],"securityClassification":"01",
            "enterpriseName":"COMAC"}
    dmCode_para = {"modelIdentCode":"ARJ",
                    "systemDiffCode":"A",
                    "systemCode":"00",
                    "subSystemCode":"0",
                    "subSubSystemCode":"0",
