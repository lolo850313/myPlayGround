...
schema = "ITEM"
rootPath = "E:\\手册发布a\\ssm201912\\SSM-2019年12月_test\\SSM-2019年12月_test\\"
...
for f in dir:
    ...
    for dmodule in dmoduleArr:
        ...
        old_title = pre + dmCode.attrib["modelIdentCode"] + "-" \
        ...
        language.attrib["languageIsoCode"] = "sx"
        language.attrib["countryIsoCode"] = "US"
...
xsd_dic = {"SSM":"xml_schema_flat\\descript.xsd", "ITEM" : "xml_schema_flat\\descript.xsd"}
