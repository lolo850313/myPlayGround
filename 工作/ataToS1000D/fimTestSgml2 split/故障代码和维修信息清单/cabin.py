...
def cabinfile(dirPath,excelPath,issueNumber,date):
	import xlrd
	...
	etree.ElementTree(root).write(dirPath + '/DMC-ARJ21-A-00-41-07-03A-414A-A.xml',xml_declaration=True,pretty_print=True,encoding="utf-8")
